...
class InterBlock extends StatelessWidget {
  String title;
  String imagePath;
  InterBlock(this.title, this.imagePath);
  @override
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: Center(
                              child: Text("JOHN DOE", style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontFamily: "GOTHIC")),
                            ),
                          ),
                          Container(
                            height: 140,
                              ...
                              children: <Widget>[
                                Expanded(
                                    ...
                                    child:Container(
                                        ...
                                        width: double.infinity,
                                        child: Center(
                                          child: Image.asset("images/teamwork.png", fit: BoxFit.cover,),
                                        ),
                                    )),
                                Expanded(
                                    flex: 4,
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: <Widget>[
                                                Text("Cabinet :", style: TextStyle(fontSize: 10, color: Colors.grey, fontFamily: "GOTHIC")),
                                                Text("SOCOGEC"),
                                              ],
                                            ),
                                          ),
